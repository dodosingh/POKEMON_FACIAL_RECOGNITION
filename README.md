Overview
This project focuses on : Implementing a machine learning pipeline that matches human images to the most similar Pokémon based on visual features using deep learning models like VGG16.
...
Scrapes Pokémon names, forms, and types from the Bulbapedia National Pokédex page.
